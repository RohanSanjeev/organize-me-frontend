...
import {listAllOrders, updateOrderMachineID, updateOrderStatus } from "../actions/orderAction"

class AssignProductionPage extends Component {
    ...
    handleUpdateOrder = (orderId) => {
        ...
        // Update the machine ID of the order
        this.props.dispatch(updateOrderMachineID(orderId, machineId));

        // Update the status of the order to 'in production'
        this.props.dispatch(updateOrderStatus(orderId, 'in production'));
    ...
    renderOrderModal = () => {
        const { selectedOrder, machineId } = this.state;
...
function mapStateToProps(state) {
  ...
  export default connect(mapStateToProps)(AssignProductionPage);